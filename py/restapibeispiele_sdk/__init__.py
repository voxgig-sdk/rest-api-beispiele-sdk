...
from restapibeispiele_sdk.utility import register

# Load features
from restapibeispiele_sdk.feature.base_feature import RestApiBeispieleBaseFeature
from restapibeispiele_sdk.features import _has_feature, _make_feature
...
class RestApiBeispieleSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RestApiBeispieleUtility()
        self._utility = utility

        from restapibeispiele_sdk.config import shared_config
    ...
    def get_utility(self):
        return RestApiBeispieleUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RestApiBeispieleSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Delete(self, data=None) -> "DeleteEntity":
        ...
        from restapibeispiele_sdk.entity.delete_entity import DeleteEntity
    ...
    def Product(self, data=None) -> "ProductEntity":
        ...
        from restapibeispiele_sdk.entity.product_entity import ProductEntity
