# RestApiBeispiele Python SDK Reference

Complete API reference for the RestApiBeispiele Python SDK.
...
#### `RestApiBeispieleSDK.test(testopts=None, sdkopts=None)`
...
Create a new `DeleteEntity` instance. Pass `None` for no initial data.
...
Create a new `DeleteEntity` instance with the same options.
