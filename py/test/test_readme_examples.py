# RestApiBeispiele SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RestApiBeispieleSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RestApiBeispieleSDK(...) and RestApiBeispieleSDK.test(...) become
#      RestApiBeispieleSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "restapibeispiele_sdk"
_SDK_CLASS = "RestApiBeispieleSDK"
