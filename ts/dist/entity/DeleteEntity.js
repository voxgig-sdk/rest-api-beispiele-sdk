...
class DeleteEntity extends RestApiBeispieleEntityBase_1.RestApiBeispieleEntityBase {
    ...
    make() {
        return new DeleteEntity(this._client, this.entopts());
    }
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<DeleteEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
