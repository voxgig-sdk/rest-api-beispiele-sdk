...
function envOverride(m) {
    if ('TRUE' === process.env.REST_API_BEISPIELE_TEST_LIVE ||
        'TRUE' === process.env.REST_API_BEISPIELE_TEST_OVERRIDE) {
    ...
    m.REST_API_BEISPIELE_TEST_EXPLAIN = process.env.REST_API_BEISPIELE_TEST_EXPLAIN || m.REST_API_BEISPIELE_TEST_EXPLAIN;
    return m;
}
