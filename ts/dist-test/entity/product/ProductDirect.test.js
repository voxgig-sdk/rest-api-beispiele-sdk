...
(0, node_test_1.describe)('ProductDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.RestApiBeispieleSDK({
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RestApiBeispieleSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['REST_API_BEISPIELE_TEST_PRODUCT_ENTID'];
    ...
    const client = new __1.RestApiBeispieleSDK({
        base: 'http://localhost:8080',
