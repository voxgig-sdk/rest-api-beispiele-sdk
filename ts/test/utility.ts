...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.RESTAPIBEISPIELE_TEST_LIVE ||
    'TRUE' === process.env.RESTAPIBEISPIELE_TEST_OVERRIDE
  ) {
  ...
  m.RESTAPIBEISPIELE_TEST_EXPLAIN = process.env.RESTAPIBEISPIELE_TEST_EXPLAIN || m.RESTAPIBEISPIELE_TEST_EXPLAIN
