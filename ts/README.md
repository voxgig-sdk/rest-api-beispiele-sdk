...
`client.Delete()` — each with a small set of operations (`load`, `create`, `update`, `remove`, `patch`)
...
| `tester(testopts?, sdkopts?)` | `RestApiBeispieleSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `RestApiBeispieleSDK.test(testopts?, sdkopts?)` | `RestApiBeispieleSDK` | Create a test-mode client. |
...
| `client` | `client(): RestApiBeispieleSDK` | Return the parent SDK client. |
...
Create an instance: `const delete_ = client.Delete()`
...
rest-api-beispiele/
├── src/
│   ├── RestApiBeispieleSDK.ts        # Main SDK class
