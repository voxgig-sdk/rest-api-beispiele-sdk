// Command RestApiBeispiele-cli is a CLI + REPL for the RestApiBeispiele SDK,
...
const prompt = "rest-api-beispiele"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "delete product"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      REST_API_BEISPIELE_APIKEY (api key), REST_API_BEISPIELE_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: REST_API_BEISPIELE_APIKEY carries the API key and
	// REST_API_BEISPIELE_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("REST_API_BEISPIELE_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("REST_API_BEISPIELE_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewRestApiBeispieleSDK(opts)
