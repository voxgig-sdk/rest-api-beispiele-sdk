...
func registerSDKWords(r *eng.Registry, client *sdk.RestApiBeispieleSDK) {
...
func runOp(client *sdk.RestApiBeispieleSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
