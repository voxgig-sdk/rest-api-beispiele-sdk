// Command RestApiBeispiele-mcp is an MCP server exposing the RestApiBeispiele
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RestApiBeispiele_list  — list records of an entity
//	RestApiBeispiele_load  — load a single record of an entity
//
