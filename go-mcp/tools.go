...
type Args struct {
	Entity string         `json:"entity" jsonschema:"delete | product"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.RestApiBeispieleSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "rest-api-beispiele_list",
		Description: "List records from RestApiBeispiele. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "rest-api-beispiele_load",
		Description: "Load a single record from RestApiBeispiele. " +
...
func runOp(client *sdk.RestApiBeispieleSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RestApiBeispieleSDK, name string) (sdk.RestApiBeispieleEntity, error) {
	switch strings.ToLower(name) {
	case "delete":
		return client.Delete(nil), nil
	case "product":
