...
// RestApiBeispiele SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RestApiBeispieleSDK::test)
...
{
    private const SDK_CLASS = 'RestApiBeispieleSDK';
    ...
    private const SDK_BASE = 'restapibeispiele_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../restapibeispiele_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
