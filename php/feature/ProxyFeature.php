...
// RestApiBeispiele SDK proxy feature
...
class RestApiBeispieleProxyFeature extends RestApiBeispieleBaseFeature
{
    ...
    public function init(RestApiBeispieleContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RestApiBeispieleContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
