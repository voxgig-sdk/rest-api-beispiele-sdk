...
// RestApiBeispiele SDK ratelimit feature
...
class RestApiBeispieleRatelimitFeature extends RestApiBeispieleBaseFeature
{
    ...
    private function _acquire(RestApiBeispieleContext $ctx): void
    {
    ...
    private function _track(RestApiBeispieleContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
