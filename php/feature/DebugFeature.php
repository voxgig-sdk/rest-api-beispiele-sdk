...
// RestApiBeispiele SDK debug feature
...
class RestApiBeispieleDebugFeature extends RestApiBeispieleBaseFeature
{
    ...
    private function _finish(RestApiBeispieleContext $ctx, bool $ok): void
    {
