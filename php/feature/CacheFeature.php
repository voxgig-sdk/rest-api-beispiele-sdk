...
// RestApiBeispiele SDK cache feature
...
class RestApiBeispieleCacheFeature extends RestApiBeispieleBaseFeature
{
    ...
    private function _through(RestApiBeispieleContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
