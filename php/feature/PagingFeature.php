...
// RestApiBeispiele SDK paging feature
...
class RestApiBeispielePagingFeature extends RestApiBeispieleBaseFeature
{
    ...
    private function _is_list(RestApiBeispieleContext $ctx): bool
    {
