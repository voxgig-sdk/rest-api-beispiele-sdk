...
// RestApiBeispiele SDK timeout feature
...
class RestApiBeispieleTimeoutFeature extends RestApiBeispieleBaseFeature
{
    ...
    private function _with_timeout(RestApiBeispieleContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RestApiBeispieleContext $_ctx, float $ms): void
    {
        $client = $this->client;
