...
// RestApiBeispiele SDK metrics feature
...
class RestApiBeispieleMetricsFeature extends RestApiBeispieleBaseFeature
{
    ...
    private function _record(RestApiBeispieleContext $ctx, bool $ok): void
    {
