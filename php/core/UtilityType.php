...
// RestApiBeispiele SDK utility type

class RestApiBeispieleUtility
{
    ...
    public static function copy(RestApiBeispieleUtility $src): RestApiBeispieleUtility
    {
        $u = new RestApiBeispieleUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
