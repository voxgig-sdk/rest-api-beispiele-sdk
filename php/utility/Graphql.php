...
// RestApiBeispiele SDK utility: graphql
//
...
class RestApiBeispieleGraphql
{
    ...
    // equivalent.
    public static function body(RestApiBeispieleContext $ctx): mixed
    {
    ...
    public static function errors(RestApiBeispieleContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
