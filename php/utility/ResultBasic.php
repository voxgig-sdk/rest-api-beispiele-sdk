...
// RestApiBeispiele SDK utility: result_basic

class RestApiBeispieleResultBasic
{
    public static function call(RestApiBeispieleContext $ctx): ?RestApiBeispieleResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof RestApiBeispieleError) ? $result->err->msg : (string)$result->err;
