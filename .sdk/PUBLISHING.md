...
|---|---|---|
| `ts/` | @voxgig-sdk/rest-api-beispiele-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/rest-api-beispiele-sdk \
      --repository voxgig-sdk/rest-api-beispiele-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/rest-api-beispiele-sdk` shows it, and
`npm trust revoke @voxgig-sdk/rest-api-beispiele-sdk --id=<id>` removes it.
