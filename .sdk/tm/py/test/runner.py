...
class RestApiBeispieleTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RestApiBeispieleTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = RestApiBeispieleTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = RestApiBeispieleTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
