...
// RestApiBeispiele SDK idempotency feature
...
class RestApiBeispieleIdempotencyFeature extends RestApiBeispieleBaseFeature
{
    ...
    private function _mutating(RestApiBeispieleContext $ctx): bool
    {
