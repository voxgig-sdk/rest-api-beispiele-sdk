...
// RestApiBeispiele SDK streaming feature
...
class RestApiBeispieleStreamingFeature extends RestApiBeispieleBaseFeature
{
    ...
    private function _iterate(RestApiBeispieleResult $result): \Generator
    {
    ...
    private function _streamable(RestApiBeispieleContext $ctx): bool
    {
