...
// RestApiBeispiele SDK audit feature
...
class RestApiBeispieleAuditFeature extends RestApiBeispieleBaseFeature
{
    ...
    private function _emit(RestApiBeispieleContext $ctx, string $outcome): void
    {
