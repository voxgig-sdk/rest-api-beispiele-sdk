...
// RestApiBeispiele SDK rbac feature
...
class RestApiBeispieleRbacFeature extends RestApiBeispieleBaseFeature
{
    ...
    private function _required(RestApiBeispieleContext $ctx): ?string
    {
    ...
    private function _reject(RestApiBeispieleContext $ctx, string $required): void
    {
    ...
    private function _track(RestApiBeispieleContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
