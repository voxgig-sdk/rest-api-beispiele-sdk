...
// RestApiBeispiele SDK netsim feature
...
class RestApiBeispieleNetsimFeature extends RestApiBeispieleBaseFeature
{
    ...
    private function _simulate(RestApiBeispieleContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RestApiBeispieleContext $ctx, array $applied): void
    {
        $client = $this->client;
