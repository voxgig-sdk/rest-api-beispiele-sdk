...
// RestApiBeispiele SDK telemetry feature
...
class RestApiBeispieleTelemetryFeature extends RestApiBeispieleBaseFeature
{
    ...
    private function _close(RestApiBeispieleContext $ctx, bool $ok): void
    {
