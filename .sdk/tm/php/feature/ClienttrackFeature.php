...
// RestApiBeispiele SDK clienttrack feature
...
class RestApiBeispieleClienttrackFeature extends RestApiBeispieleBaseFeature
{
    ...
    public function PostConstruct(RestApiBeispieleContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RestApiBeispiele-SDK';
