...
// RestApiBeispiele SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class RestApiBeispieleTransformResponse
{
    public static function call(RestApiBeispieleContext $ctx): mixed
    {
        ...
        $transform = RestApiBeispieleHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
