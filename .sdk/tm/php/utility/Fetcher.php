...
// RestApiBeispiele SDK utility: fetcher

class RestApiBeispieleFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RestApiBeispieleSDK/1.0)';
    ...
    public static function call(RestApiBeispieleContext $ctx, string $fullurl, array $fetchdef): array
    {
