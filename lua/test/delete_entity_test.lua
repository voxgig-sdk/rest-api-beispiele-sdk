...
describe("DeleteEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set REST_API_BEISPIELE_TEST_DELETE_ENTID JSON to run live")
      return
    end
...
function delete_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("REST_API_BEISPIELE_TEST_DELETE_ENTID")
