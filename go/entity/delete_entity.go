...
type DeleteEntity struct {
	name    string
	client  *core.RestApiBeispieleSDK
...
func NewDeleteEntity(client *core.RestApiBeispieleSDK, entopts map[string]any) *DeleteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeleteEntity) GetName() string { return e.name }
...
func (e *DeleteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeleteEntity) Deleted() bool {
	return e.deleted
}


func (e *DeleteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeleteEntity(e.client, opts)
}

func (e *DeleteEntity) Data(args ...any) any {
...
func (e *DeleteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Delete; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeleteEntity) DataTyped(data ...Delete) Delete {
	if len(data) > 0 {
		return typedFrom[Delete](e.Data(asMap(data[0])))
	}
	return typedFrom[Delete](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Delete (all fields
// optional at the wire level).
func (e *DeleteEntity) MatchTyped(match ...Delete) Delete {
	if len(match) > 0 {
		return typedFrom[Delete](e.Match(asMap(match[0])))
	}
	return typedFrom[Delete](e.Match())
}
...
func (e *DeleteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeleteEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DeleteEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DeleteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeleteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *DeleteEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeleteRemoveMatch and returns an Delete. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *DeleteEntity) RemoveTyped(reqmatch DeleteRemoveMatch, ctrl map[string]any) (Delete, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Delete{}, err
	}
	return typedFrom[Delete](res), nil
}



func (e *DeleteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
