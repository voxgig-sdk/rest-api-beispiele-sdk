...
const testSeed = `map[string]any{"entity": map[string]any{"delete": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "product": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
