...
func TestDeleteEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		deleteRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.delete")))
...
func deleteBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("REST_API_BEISPIELE_TEST_DELETE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["REST_API_BEISPIELE_TEST_DELETE_ENTID"])
