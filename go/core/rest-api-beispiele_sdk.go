...
type RestApiBeispieleSDK struct {
	Mode     string
...
func (sdk *RestApiBeispieleSDK) OptionsMap() map[string]any {
...
func (sdk *RestApiBeispieleSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RestApiBeispieleSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RestApiBeispieleSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RestApiBeispieleSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RestApiBeispieleSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RestApiBeispieleSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RestApiBeispieleSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RestApiBeispieleSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RestApiBeispieleSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RestApiBeispieleSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *RestApiBeispieleSDK {
	...
	sdk := NewRestApiBeispieleSDK(sdkopts)
	sdk.Mode = "test"
