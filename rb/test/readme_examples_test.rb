...
#      offline in seeded test mode (RestApiBeispieleSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RestApiBeispiele_sdk.rb")
  SDK_CLASS = "RestApiBeispieleSDK"
